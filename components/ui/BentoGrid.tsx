...
const handleCopy = () => {
navigator.clipboard.writeText('ruczkowski.m@gmail.com');
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        <div className="w-full h-full absolute">
          ...
          {img && (
            <img src={img} alt={img} className={cn(imgClassName, "w-full ")} />
          )}
        </div>
        <div
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/bento:translate-x-2 translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10"
          )}
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute right-3 lg:-right-2">
              ...
              lg:ox-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
